  ...
  if (isFileProtocol) {
    return `
      <div class="song-video song-video--blocked">
        ...
        <p class="song-video__hint">Depois acesse <code>http://localhost:3000/pages/musica.html?id=${song.id}</code></p>
      </div>
    `;
  }
  ...
  if (!song) {
    ...
    container.innerHTML = `
      <div class="profile-not-found">
        ...
        <a href="${resolvePath("pages/musicas.html")}" class="btn btn-primary">${labels.notFoundBtn}</a>
      </div>
    `;
    return;
  }
